...
import { AbstractControl, FormControl, FormGroup, ValidationErrors, ValidatorFn, Validators, ReactiveFormsModule, FormsModule } from '@angular/forms';
import { Router } from '@angular/router';
import { JwtHelperService } from '@auth0/angular-jwt';
import { AuthModel } from 'src/app/interfaces/auth-model';
import { ClientModel } from 'src/app/interfaces/client-model';
import { ClientRegistrationModel } from 'src/app/interfaces/client-registration';
...
export class RegisterComponent implements OnInit {
  ...
  submit() {
    ...
    var registerData: ClientRegistrationModel = {
    ...
    // Call auth service
    this.authService.registerAsClient(registerData).subscribe((response: any) => {
